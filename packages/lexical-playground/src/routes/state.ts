import { parseAllowedFontSize } from '$lib/plugins/toolbar/font-size.svelte';
import { parseAllowedColor } from '$lib/ui/color-picker.svelte';
import { $createLinkNode } from '@lexical/link';
import { $createListNode, $createListItemNode } from '@lexical/list';
import { $createHeadingNode, $createQuoteNode } from '@lexical/rich-text';
import { $getRoot, $createTextNode, $createParagraphNode, type DOMConversionMap, TextNode, $isTextNode } from 'lexical';
