<script lang="ts" module>
	...
	import { useToolbarState } from '$lib/context/toolbar-context.svelte';
	import { $createAutocompleteNode as createAutocompleteNode$, AutocompleteNode } from '$lib/nodes/autocomplete-node';
...
<script lang="ts">
	...
	const toolbarState = $derived(useToolbarState().toolbarState());
