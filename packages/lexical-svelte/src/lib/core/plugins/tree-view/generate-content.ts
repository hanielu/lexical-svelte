...
import type { LexicalCommandLog } from './use-lexical-commands-log.svelte.js';
...
function printNode(node: LexicalNode, customPrintNode?: CustomPrintNodeFn, obfuscateText: boolean = false) {
	const customPrint: string | undefined = customPrintNode ? customPrintNode(node, obfuscateText) : undefined;
